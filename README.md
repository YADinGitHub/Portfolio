...
| :---------------------- | :---------------------- | :---------------------- |
| [Анализ рекламного размещения клиента](Analysis of the client's ad placement) | На основе полученных данных провести анализ рекламного размещения клиента. | *pandas*, *matplotlib*, *seaborn*|
